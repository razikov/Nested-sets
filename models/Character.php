...
//    public $traits; // adv/disAdv
    ...
    {
        return $this->acc_strength + self::BASE_STRENGTH;
    }
    
    public function setStrength($value)
    {
        $this->acc_strength = $value - self::BASE_STRENGTH;
    ...
    {
        return $this->acc_strength * self::COST_STRENGTH;
    }
    ...
    {
        return $this->acc_dexterity + self::BASE_DEXTERITY;
    }
    
    public function setDexterity($value)
    {
        $this->acc_dexterity = $value - self::BASE_DEXTERITY;
    ...
    {
        return $this->acc_dexterity * self::COST_DEXTERITY;
    }
    ...
    {
        return $this->acc_intelegence + self::BASE_INTELEGENCE;
    }
    
    public function setIntelegence($value)
    {
        $this->acc_intelegence = $value - self::BASE_INTELEGENCE;
    ...
    {
        return $this->acc_intelegence * self::COST_INTELEGENCE;
    }
    ...
    {
        return $this->acc_health + self::BASE_HEALTH;
    }
    
    public function setHealth($value)
    {
        $this->acc_health = $value - self::BASE_HEALTH;
    ...
    {
        return $this->acc_health * self::COST_HEALTH;
    }
    ...
    {
        return $this->acc_hit_points + $this->strength;
    }
    
    public function setHitPoints($value)
    {
        $this->acc_hit_points = $value - $this->strength;
    ...
    {
        return $this->acc_hit_points * self::COST_HIT_POINT;
    }
    ...
    {
        return $this->acc_will + $this->intelegence;
    }
    
    public function setWill($value)
    {
        $this->acc_will = $value - $this->intelegence;
    ...
    {
        return $this->acc_will * self::COST_WILL;
    }
    ...
    {
        return $this->acc_perception + $this->intelegence;
    }
    
    public function setPerception($value)
    {
        $this->acc_perception = $value - $this->intelegence;
    ...
    {
        return $this->acc_perception * self::COST_PERCEPTION;
    }
    ...
    {
        return $this->acc_fatigue_points + $this->hitPoints;
    }
    
    public function setFatiguePoints($value)
    {
        $this->acc_fatigue_points = $value - $this->hitPoints;
    ...
    {
        return $this->acc_fatigue_points * self::COST_FATIGUE_POINTS;
    }
    ...
    {
        return ($this->health + $this->dexterity) / 4 + $this->acc_base_speed * self::BASE_SPEED_POINT_PER_LEVEL;
    }
    
    public function setBaseSpeed($value)
    {
        $this->acc_base_speed = floor( ($value - ($this->health + $this->dexterity) / 4) / self::BASE_SPEED_POINT_PER_LEVEL);
    ...
    {
        return $this->acc_base_speed * self::COST_BASE_SPEED;
    }
    ...
    {
        return floor($this->baseSpeed) + $this->acc_base_move;
    }
    
    public function setBaseMove($value)
    {
        $this->acc_base_move = $value - floor($this->baseSpeed);
    ...
    {
        return $this->acc_base_move * self::COST_MOVE;
    }
