...
use Yii;
use app\modules\UserImportExport\helpers\XmlHelper;
...
class ImportUserForm extends ImportUser
{
    ...
    public function load($data, $formName = NULL)
    {
        ...
        if ($this->users) {
            $logins = \yii\helpers\ArrayHelper::getValue($data, 'login');
            $rawPasswords = \yii\helpers\ArrayHelper::getValue($data, 'rawPassword');
    ...
    protected function uploadFile($path)
    {
        ...
        $mimeType = \yii\helpers\FileHelper::getMimeType($path);
