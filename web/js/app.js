var NS = (function (exports) {
            ...
            Dep.prototype.notify = function notify () {
              ...
              if ("dev" !== 'production' && !config$1.async) {
            ...
            function updateListeners (
              ...
              for (name in on$$1) {
                ...
                if (isUndef(cur)) {
                  ...
                  if (isUndef(cur.fns)) {
                    cur = on$$1[name] = createFnInvoker(cur, vm);
                  }
            ...
            function mountComponent (
              ...
              var updateComponent;
              /* istanbul ignore if */
              if ("dev" !== 'production' && config$1.performance && mark) {
            ...
            var TreeTable = {
            render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('table',[_c('thead',[_c('tr',_vm._l((_vm.columns),function(col){return _c('th',[_vm._v("\n                "+_vm._s(col.header)+"\n            ")])}),0)]),_vm._v(" "),_c('tbody',_vm._l((_vm.rows),function(row){return _c('tr',_vm._l((_vm.columns),function(col){return _c('td',[_vm._v("\n                "+_vm._s(row[col.id])+"\n            ")])}),0)}),0),_vm._v(" "),_vm._m(0)])},
            staticRenderFns: [function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('tfoot',[_c('tr',[_c('td')])])}],
                    props: {
            ...
            var Character = {
            render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"fieldset--row"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-24 fieldset--col"},[_c('div',{staticClass:"fieldset--padding"},[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        ST: "+_vm._s(_vm.st + _vm.fGetAttributeBonusByName('st'))+" ("+_vm._s((_vm.st - 10) * 10)+")\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        DX: "+_vm._s(_vm.dx + _vm.fGetAttributeBonusByName('dx'))+" ("+_vm._s((_vm.dx - 10) * 20)+")\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        IQ: "+_vm._s(_vm.iq + _vm.fGetAttributeBonusByName('iq'))+" ("+_vm._s((_vm.iq - 10) * 20)+")\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        HT: "+_vm._s(_vm.ht + _vm.fGetAttributeBonusByName('ht'))+" ("+_vm._s((_vm.ht - 10) * 10)+")\n                    ")])]),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        HP: "+_vm._s(_vm.hitPoints)+" ("+_vm._s(_vm.hp * 2)+")\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        Will: "+_vm._s(_vm.will + (_vm.iq + _vm.fGetAttributeBonusByName('iq')) + _vm.fGetAttributeBonusByName('will'))+" ("+_vm._s(_vm.will * 5)+")\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        Perception: "+_vm._s(_vm.perception + (_vm.iq + _vm.fGetAttributeBonusByName('iq')) + _vm.fGetAttributeBonusByName('perception'))+" ("+_vm._s(_vm.perception * 5)+")\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        FP: "+_vm._s(_vm.fp + (_vm.ht + _vm.fGetAttributeBonusByName('ht')) + _vm.fGetAttributeBonusByName('fp'))+" ("+_vm._s(_vm.fp * 3)+")\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        BS: "+_vm._s(_vm.speed + Math.round(((_vm.ht + _vm.fGetAttributeBonusByName('ht')) + (_vm.dx + _vm.fGetAttributeBonusByName('dx')))/4) + _vm.fGetAttributeBonusByName('speed'))+" ("+_vm._s(_vm.speed * 5)+")\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        BM: "+_vm._s(_vm.move + (_vm.speed + Math.round(((_vm.ht + _vm.fGetAttributeBonusByName('ht')) + (_vm.dx + _vm.fGetAttributeBonusByName('dx')))/4) + _vm.fGetAttributeBonusByName('speed')) + _vm.fGetAttributeBonusByName('move'))+" ("+_vm._s(_vm.move * 5)+")\n                    ")])]),_vm._v(" "),_c('hr'),_vm._v(" "),_vm._m(0),_vm._v(" "),_c('hr'),_vm._v(" "),_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        directDamage\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        amplitudeDamage\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        move\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        Парирование: \n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        Блок: \n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        Уклонение: "+_vm._s(_vm.speed + Math.round(((_vm.ht + _vm.fGetAttributeBonusByName('ht')) + (_vm.dx + _vm.fGetAttributeBonusByName('dx')))/4) + _vm.fGetAttributeBonusByName('speed') + 3)+"\n                    ")])]),_vm._v(" "),_c('hr'),_vm._v(" "),_vm._m(1),_vm._v(" "),_c('hr'),_vm._v(" "),_c('div',{staticClass:"row"},[_vm._v("\n                    Очков: \n                ")]),_vm._v(" "),_c('hr'),_vm._v(" "),_c('div',{staticClass:"row"},[_c('ul',_vm._l((_vm.advantageList),function(advantage){return _c('li',[_vm._v("\n                            "+_vm._s(advantage.name.value)+"\n                        ")])}),0)]),_vm._v(" "),_c('TreeTable',{attrs:{"data":_vm.treeData,"columns":_vm.treeColumns}})],1)])]),_vm._v(" "),_vm._m(2)])},
            staticRenderFns: [function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        baseLoad\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        load\n                    ")]),_vm._v(" "),_c('div',{staticClass:"col-sm-12 col-lg-2"},[_vm._v("\n                        burdenName\n                    ")])])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"row"},[_c('div',{staticClass:"col-sm-12 col-lg-6"})])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('br')])}],
                    components: {
                        TreeTable
                    },
                    computed: {
        ...
        <g className='hexagon-group'>\n\
            ...
            function calculateCoordinates(center, orientation) {
              ...
              for (var i = 0; i < 6; i++) {
                var offset = getPointOffset(i, orientation, size);
                console.log(center, offset);
                var point = new Point(center.x + offset.x, center.y + offset.y);
                corners.push(point);
              }
            ...
            function render() {
              ...
              var hexas = rectangle(10, 10);
              var cornerCoords = calculateCoordinates(HexUtils.hexToPixel(hexas[1], layout), layout.orientation);
